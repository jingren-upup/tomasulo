...
public class tomasulomain {
	...
	public static tomasulomain tomma;
...
//						filename = r2.readLine();
						...
						System.out.println("Extraordinarily");//error exception
					}
	...
	public void run_p(){
			...
			if(pc_read != ud.tomdata.pc){
				...
				}else if(information[ud.tomdata.pc].charAt(0) == 'D'){//divide
